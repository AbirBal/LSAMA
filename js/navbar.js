...
const translations = {
  fr: {
    ...
    // ---- Actualités — cartes ----
    'actu1-h3':   'Réunion du Conseil du Laboratoire LSAMA',
    'actu1-date': '11 octobre 2025',
    'actu1-p':    'La réunion du Conseil du Laboratoire LSAMA se tiendra le samedi 11 octobre 2025, à la Bibliothèque du Département de Physique, de 10h00 à 12h00.',
    'actu2-h3':   'Soutenance de thèse — Marwa Mhamdi',
    'actu2-date': '12 décembre 2025',
    'actu2-p':    'Marwa Mhamdi présentera ses travaux de recherche lors d\'une soutenance ouverte aux membres du laboratoire LSAMA et des enseignants-chercheurs invités.',
    'actu3-h3':   'Réunion annuelle du laboratoire LSAMA',
    'actu3-date': '26 mars 2026',
    'actu3-p':    'La réunion annuelle a permis de présenter les projets des équipes et d\'établir de nouvelles collaborations nationales et internationales.',

    // ---- Équipes de Recherche — contenu figé ----
    'eq-hero-p':          'Le laboratoire LSAMA est organisé en <strong style="color:var(--teal-light);">4 équipes spécialisées</strong>, bénéficiant d\'une large autonomie scientifique et couvrant des domaines allant de la spectroscopie astrophysique à la physique des lasers, en passant par la biologie moléculaire.',
    'eq-quick-badge':     'Accès rapide',
    'eq-quick-h2':        'Explorer par Thématique',
    'eq-quick-p':         'Naviguez directement vers l\'équipe correspondant à votre domaine d\'intérêt',
    // DMEAF card
    'eq-dmeaf-tag':       'Physique atomique',
    'eq-dmeaf-h3':        'Dynamique des Molécules Excitées et Atomes Froids',
    'eq-dmeaf-p':         'L\'équipe DMEAF étudie les processus dynamiques fondamentaux dans les molécules excitées électroniquement et les systèmes d\'atomes refroidis par laser. Ces recherches ouvrent des perspectives en métrologie, en information quantique et en astrophysique de laboratoire.',
    'eq-dmeaf-meta1':     'Spectroscopie laser avancée',
    'eq-dmeaf-meta2':     'Refroidissement atomique',
    'eq-dmeaf-meta3':     'Dynamique quantique',
    'eq-dmeaf-quick-h4':  'Atomes Froids',
    'eq-dmeaf-quick-p':   'Molécules excitées, refroidissement laser, dynamique quantique',
    // SDMI2A card
    'eq-sdmi2a-tag':      'Astrophysique & Atmosphère',
    'eq-sdmi2a-h3':       'Structure et Dynamique de Molécules d\'Intérêt Astrophysique et Atmosphérique',
    'eq-sdmi2a-p':        'L\'équipe SDMI2A se consacre à la caractérisation spectroscopique fine de molécules présentes dans les milieux astrophysiques et atmosphériques. Ces données sont essentielles pour l\'interprétation des observations télescopiques et la modélisation climatique.',
    'eq-sdmi2a-meta1':    'Spectroscopie astrophysique',
    'eq-sdmi2a-meta2':    'Physique atmosphérique',
    'eq-sdmi2a-meta3':    'Bases de données moléculaires',
    'eq-sdmi2a-quick-h4': 'Astrophysique',
    'eq-sdmi2a-quick-p':  'Spectroscopie de molécules astrophysiques et atmosphériques',
    // MIBP card
    'eq-mibp-tag':        'Biomédical & Pharmacie',
    'eq-mibp-h3':         'Molécules d\'Intérêt Biologique et Pharmaceutiques',
    'eq-mibp-p':          'L\'équipe MIBP applique les techniques spectroscopiques à l\'analyse structurale et fonctionnelle de molécules à haute valeur biologique et pharmaceutique. Ces travaux contribuent directement à la recherche biomédicale et au développement de nouveaux médicaments.',
    'eq-mibp-meta1':      'Pharmacologie moléculaire',
    'eq-mibp-meta2':      'Analyse structurale',
    'eq-mibp-meta3':      'Applications biomédicales',
    'eq-mibp-quick-h4':   'Biomédical',
    'eq-mibp-quick-p':    'Molécules biologiques et pharmaceutiques par spectroscopie',
    // ELIBSF card
    'eq-elibsf-tag':      'Lasers & Fluorescence',
    'eq-elibsf-h3':       'Expériences LIBS et Fluorescence',
    'eq-elibsf-p':        'L\'équipe ELIBSF développe et applique des techniques de spectroscopie laser avancées — notamment la spectroscopie de claquage induit par laser (LIBS) et la fluorescence — pour l\'analyse élémentaire et moléculaire de matériaux dans des contextes industriels, patrimoniaux et environnementaux.',
    'eq-elibsf-meta1':    'Spectroscopie LIBS',
    'eq-elibsf-meta2':    'Fluorescence laser',
    'eq-elibsf-meta3':    'Applications industrielles',
    'eq-elibsf-quick-h4': 'LIBS & Fluorescence',
    'eq-elibsf-quick-p':  'Techniques laser pour l\'analyse de matériaux',

    // ---- Contact ----
    'contact-social-h3':       'Réseaux sociaux',
    'contact-addr-val':        'Faculté des Sciences de Tunis<br>Département de Physique, Bureau 212<br>2092 Manar II, Tunis, Tunisie',
    'contact-ref-val':         'LR01ES09 — Université de Tunis El Manar',
    'contact-map-label':       'Faculté des Sciences de Tunis — 2092 Manar II',
    'contact-map-open':        'Ouvrir',
    'contact-form-h2':         'Envoyer un message',
    'contact-form-p':          'Remplissez le formulaire ci-dessous et nous vous répondrons dans les meilleurs délais.',
    'contact-lbl-firstname':   'Prénom',
    'contact-lbl-lastname':    'Nom',
    'contact-lbl-email':       'Email',
    'contact-lbl-phone':       'Téléphone',
    'contact-lbl-subject':     'Objet',
    'contact-lbl-message':     'Message',
    'contact-ph-firstname':    'Votre prénom',
    'contact-ph-lastname':     'Votre nom',
    'contact-ph-email':        'votre@email.com',
    'contact-ph-phone':        '+216 XX XXX XXX',
    'contact-ph-message':      'Décrivez votre demande…',
    'contact-select-default':  'Sélectionner un objet…',
    'contact-opt-collab':      'Collaboration scientifique',
    'contact-opt-these':       'Candidature doctorat',
    'contact-opt-stage':       'Demande de stage',
    'contact-opt-info':        'Demande d\'information',
    'contact-opt-presse':      'Presse / Médias',
    'contact-opt-autre':       'Autre',
    'contact-btn-send':        'Envoyer le message',
    'contact-form-note':       'Vos informations sont confidentielles et ne seront pas partagées.',
    'contact-success-h3':      'Message envoyé !',
    'contact-success-p':       'Merci de nous avoir contactés. Nous vous répondrons dans les plus brefs délais.',
  ...
  en: {
    ...
    'actu1-h3':   'LSAMA Laboratory Council Meeting',
    'actu1-date': 'October 11, 2025',
    'actu1-p':    'The LSAMA Laboratory Council meeting will be held on Saturday, October 11, 2025, at the Physics Department Library, from 10:00 to 12:00.',
    'actu2-h3':   'PhD Defence — Marwa Mhamdi',
    'actu2-date': 'December 12, 2025',
    'actu2-p':    'Marwa Mhamdi will present her research work at a defence open to LSAMA laboratory members and invited faculty.',
    'actu3-h3':   'Annual Meeting of the LSAMA Laboratory',
    'actu3-date': 'March 26, 2026',
    'actu3-p':    'The annual meeting provided an opportunity to present team projects and establish new national and international collaborations.',

    // ---- Research Teams page — hardcoded content ----
    'eq-hero-p':          'The LSAMA laboratory is organized into <strong style="color:var(--teal-light);">4 specialized teams</strong>, with broad scientific autonomy covering fields from astrophysical spectroscopy to laser physics and molecular biology.',
    'eq-quick-badge':     'Quick access',
    'eq-quick-h2':        'Explore by Theme',
    'eq-quick-p':         'Navigate directly to the team matching your field of interest',
    // DMEAF card
    'eq-dmeaf-tag':       'Atomic physics',
    'eq-dmeaf-h3':        'Dynamics of Excited Molecules and Cold Atoms',
    'eq-dmeaf-p':         'The DMEAF team studies fundamental dynamic processes in electronically excited molecules and laser-cooled atomic systems. This research opens perspectives in metrology, quantum information and laboratory astrophysics.',
    'eq-dmeaf-meta1':     'Advanced laser spectroscopy',
    'eq-dmeaf-meta2':     'Atomic cooling',
    'eq-dmeaf-meta3':     'Quantum dynamics',
    'eq-dmeaf-quick-h4':  'Cold Atoms',
    'eq-dmeaf-quick-p':   'Excited molecules, laser cooling, quantum dynamics',
    // SDMI2A card
    'eq-sdmi2a-tag':      'Astrophysics & Atmosphere',
    'eq-sdmi2a-h3':       'Structure and Dynamics of Molecules of Astrophysical and Atmospheric Interest',
    'eq-sdmi2a-p':        'The SDMI2A team is dedicated to the precise spectroscopic characterisation of molecules found in astrophysical and atmospheric environments. These data are essential for interpreting telescopic observations and climate modelling.',
    'eq-sdmi2a-meta1':    'Astrophysical spectroscopy',
    'eq-sdmi2a-meta2':    'Atmospheric physics',
    'eq-sdmi2a-meta3':    'Molecular databases',
    'eq-sdmi2a-quick-h4': 'Astrophysics',
    'eq-sdmi2a-quick-p':  'Spectroscopy of astrophysical and atmospheric molecules',
    // MIBP card
    'eq-mibp-tag':        'Biomedical & Pharmacy',
    'eq-mibp-h3':         'Molecules of Biological and Pharmaceutical Interest',
    'eq-mibp-p':          'The MIBP team applies spectroscopic techniques to the structural and functional analysis of molecules of high biological and pharmaceutical value. This work contributes directly to biomedical research and the development of new drugs.',
    'eq-mibp-meta1':      'Molecular pharmacology',
    'eq-mibp-meta2':      'Structural analysis',
    'eq-mibp-meta3':      'Biomedical applications',
    'eq-mibp-quick-h4':   'Biomedical',
    'eq-mibp-quick-p':    'Biological and pharmaceutical molecules by spectroscopy',
    // ELIBSF card
    'eq-elibsf-tag':      'Lasers & Fluorescence',
    'eq-elibsf-h3':       'LIBS and Fluorescence Experiments',
    'eq-elibsf-p':        'The ELIBSF team develops and applies advanced laser spectroscopy techniques — notably Laser-Induced Breakdown Spectroscopy (LIBS) and fluorescence — for elemental and molecular analysis of materials in industrial, heritage and environmental contexts.',
    'eq-elibsf-meta1':    'LIBS spectroscopy',
    'eq-elibsf-meta2':    'Laser fluorescence',
    'eq-elibsf-meta3':    'Industrial applications',
    'eq-elibsf-quick-h4': 'LIBS & Fluorescence',
    'eq-elibsf-quick-p':  'Laser techniques for materials analysis',

    // ---- Contact ----
    'contact-social-h3':       'Social media',
    'contact-addr-val':        'Faculty of Sciences of Tunis<br>Physics Department, Office 212<br>2092 Manar II, Tunis, Tunisia',
    'contact-ref-val':         'LR01ES09 — University of Tunis El Manar',
    'contact-map-label':       'Faculty of Sciences of Tunis — 2092 Manar II',
    'contact-map-open':        'Open',
    'contact-form-h2':         'Send a message',
    'contact-form-p':          'Fill in the form below and we will get back to you as soon as possible.',
    'contact-lbl-firstname':   'First name',
    'contact-lbl-lastname':    'Last name',
    'contact-lbl-email':       'Email',
    ...
    'contact-ph-phone':        '+216 XX XXX XXX',
    'contact-ph-message':      'Describe your request…',
    'contact-select-default':  'Select a subject…',
    'contact-opt-collab':      'Scientific collaboration',
    'contact-opt-these':       'PhD application',
    'contact-opt-stage':       'Internship request',
    'contact-opt-info':        'Information request',
    'contact-opt-presse':      'Press / Media',
    'contact-opt-autre':       'Other',
    'contact-btn-send':        'Send message',
    'contact-form-note':       'Your information is confidential and will not be shared.',
    'contact-success-h3':      'Message sent!',
    'contact-success-p':       'Thank you for contacting us. We will reply as soon as possible.',
